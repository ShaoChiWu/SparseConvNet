...
files=sorted(glob.glob('/home/carbon537/SparseConvNet/examples/ScanNet/test_t/*_vh_clean_2.ply'))
files2=sorted(glob.glob('/home/carbon537/SparseConvNet/examples/ScanNet/test_t/*_vh_clean_2.labels.ply'))
