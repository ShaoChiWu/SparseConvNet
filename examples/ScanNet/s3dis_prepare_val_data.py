...
for order in orders:
    files.append('/work/carbon537/Stanford3dDataset_v1.2_Aligned_Version/' + order)
...
f = open("/home/carbon537/Area_6_Scene.txt")
...
for scene in scenes:
    ...
    #torch.save((coords,colors,w), '/work/carbon537/S3DIS_data_final/val/Area_2/' + scene + '.pth')
    torch.save((coords,colors), '/work/carbon537/S3DIS_data_final/val/Area_6_no_label/' + scene + '.pth')
    print(scene)
