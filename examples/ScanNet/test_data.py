...
for x in torch.utils.data.DataLoader(
        glob.glob('/home/carbon537/SparseConvNet/examples/ScanNet/test_t/*.pth'),
...
for idx,x in enumerate(test):
    ...
    testLabels.append(x[2].astype(np.int32))
...
test_data_loader = torch.utils.data.DataLoader(
    list(range(len(test))),batch_size=batch_size, collate_fn=testMerge, num_workers=20,shuffle=True)
